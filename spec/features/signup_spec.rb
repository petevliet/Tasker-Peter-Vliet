...
describe 'user can sign up successfully' do
    ...
    it 'guest cannot sign up with duplicate email' do
      ...
      visit '/signup'
      fill_in 'registration[first_name]', with: 'example'
      fill_in 'registration[last_name]', with: 'example'
      fill_in 'registration[email]', with: 'joe@camel.com'
      fill_in 'registration[password]', with: 'example'
      fill_in 'registration[password_confirmation]', with: 'example'
    ...
    it 'guest cannot sign up if password does not match confirmation' do
      ...
      fill_in 'registration[first_name]', with: 'example'
      fill_in 'registration[last_name]', with: 'example'
      fill_in 'registration[email]', with: 'example@example.com'
      fill_in 'registration[password]', with: 'example'
      fill_in 'registration[password_confirmation]', with: 'notexample'
    ...
    it 'guest cannot sign up if first name is blank' do
      ...
      visit '/signup'
      fill_in 'registration[first_name]', with: ''
      fill_in 'registration[last_name]', with: 'example'
      fill_in 'registration[email]', with: 'example@example.com'
      fill_in 'registration[password]', with: 'example'
      fill_in 'registration[password_confirmation]', with: 'example'
    ...
    it 'guest cannot sign up if last name is blank' do
      ...
      visit '/signup'
      fill_in 'registration[first_name]', with: 'example'
      fill_in 'registration[last_name]', with: ''
      fill_in 'registration[email]', with: 'example@example.com'
      fill_in 'registration[password]', with: 'example'
      fill_in 'registration[password_confirmation]', with: 'example'
